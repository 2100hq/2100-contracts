/**
 *Modified version of `https://etherscan.io/address/0x89d24a6b4ccb1b6faa2625fe562bdd9a23260359` for 0.5.10 and no auth
*/
...
contract DSStop is DSNote, DSAuth {
    ...
    function stop() internal auth note {
        stopped = true;
    }
    function start() internal auth note {
        stopped = false;
    }
